...
final class Version20220430011825 extends AbstractMigration
{
	/**
	 * @return string
	 */
	...
	public function up(Schema $schema): void
	{
		...
		$this->addSql('COMMENT ON COLUMN "user".email_address IS \'(DC2Type:SixtyEightPublishers\\ArchitectureBundle\\Domain\\Dto\\EmailAddress)\'');
		...
		$this->addSql('COMMENT ON COLUMN password_request.email_address IS \'(DC2Type:SixtyEightPublishers\\ArchitectureBundle\\Domain\\Dto\\EmailAddress)\'');
