...
use App\Api\V1\RequestBody\GetCookieProvidersRequestBody;
...
/**
 * @Api\Path("/cookie-providers")
 */
final class CookieProvidersController extends AbstractV1Controller
{
	 ...
	 * })
	 * @Api\RequestBody(entity="App\Api\V1\RequestBody\GetCookieProvidersRequestBody", required=true)
	 *
	...
	public function get(ApiRequest $request, ApiResponse $response): ApiResponse
	{
		...
		assert($requestEntity instanceof GetCookieProvidersRequestBody);
		...
		$data = [];
		$query = FindCookieProvidersForApiQuery::create($projectId->toString(), $requestEntity->locale)
			->withBatchSize(100);
