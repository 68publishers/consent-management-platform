		...
		Assert::equal([
			...
			new IgnoredCookieSuggestion(
				...
				new Solutions(
					$projectId,
					'fa47cb13-90a8-4eb4-b2b1-30c0acc8b54b',
					['b59ac571-538e-4412-9888-cd5a8f834118', 'IgnoredCookieSuggestion'],
					$store->getDataStore(),
					new DoNotIgnore(),
				),
			),
			new IgnoredCookieSuggestion(
					...
					[
						new CookieIsInCategoryThatIsNotAcceptedByScenario(
							...
							new Solutions(
								$projectId,
								'46ac6172-9f8e-492a-bef7-832f5055e201',
								['cccbb209-d4ea-4fdb-997d-285208061891', '561109e2-5944-44ae-aedb-dcbc58e62d55', 'ProblematicCookieSuggestion', CookieIsInCategoryThatIsNotAcceptedByScenario::TYPE],
								$store->getDataStore(),
				...
				new Solutions(
					$projectId,
					'46ac6172-9f8e-492a-bef7-832f5055e201',
					['cccbb209-d4ea-4fdb-997d-285208061891', 'IgnoredCookieSuggestion'],
					$store->getDataStore(),
					new DoNotIgnore(),
				),
			),
				...
				[
					new CookieIsInCategoryThatIsNotAcceptedByScenario(
						...
						new Solutions(
							$projectId,
							'9df8977b-9d44-46be-94ea-f6399cc327b1',
							['1f5d336e-7c96-4846-921c-f39b78ed8d21', '561109e2-5944-44ae-aedb-dcbc58e62d55', 'ProblematicCookieSuggestion', CookieIsInCategoryThatIsNotAcceptedByScenario::TYPE],
							$store->getDataStore(),
				...
				[
					new CookieIsInCategoryThatIsNotAcceptedByScenario(
						...
						new Solutions(
							$projectId,
							'43cc8ac0-24b9-4489-9ccf-b1c5bae3e4ef',
							['997637a7-595e-4242-8ccd-7dc1476aeb63', '561109e2-5944-44ae-aedb-dcbc58e62d55', 'ProblematicCookieSuggestion', CookieIsInCategoryThatIsNotAcceptedByScenario::TYPE],
							$store->getDataStore(),
				...
				[
					new CookieIsInCategoryThatIsNotAcceptedByScenario(
						...
						new Solutions(
							$projectId,
							'42c660ce-6770-4002-abd8-338a4015444d',
							['ac2cc255-8056-455f-92e8-716c6e17814e', '561109e2-5944-44ae-aedb-dcbc58e62d55', 'ProblematicCookieSuggestion', CookieIsInCategoryThatIsNotAcceptedByScenario::TYPE],
							$store->getDataStore(),
				...
				[
					new CookieIsInCategoryThatIsNotAcceptedByScenario(
						...
						new Solutions(
							$projectId,
							'42c660ce-6770-4002-abd8-338a4015444d',
							['b9e3920f-9d67-4dd6-bd9b-1d3ce244a60c', 'babc3c1a-71cc-4776-a70e-b9ac4f4ed16c', 'ProblematicCookieSuggestion', CookieIsInCategoryThatIsNotAcceptedByScenario::TYPE],
							$store->getDataStore(),
